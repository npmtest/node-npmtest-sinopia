...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sinopia/node_modules/sinopia/lib/status-cats.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sinopia/node_modules/sinopia/lib/status-cats.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sinopia/node_modules/sinopia/lib/</a> &#187; status-cats.js</div>
</div>
<div class="body">
...
&nbsp;
module.exports.get_image = <span class="fstat-no" title="function not covered" >function(status) {</span>
<span class="cstat-no" title="statement not covered" >  if (status in images) {</span>
<span class="cstat-no" title="statement not covered" >    return 'http://flic.kr/p/' + images[status]</span>
    //return 'https://secure.flickr.com/photos/girliemac/'+images[status]+'/in/set-72157628409467125/lightbox/'
  }
}
&nbsp;
module.exports.middleware = <span class="fstat-no" title="function not covered" >function(req, res, next) {</span>
<span class="cstat-no" title="statement not covered" >  var _writeHead = res.writeHead</span>
<span class="cstat-no" title="statement not covered" >  res.writeHead = <span class="fstat-no" title="function not covered" >function(status) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (status in images) {</span>
<span class="cstat-no" title="statement not covered" >      res.setHeader('X-Status-Cat', module.exports.get_image(status))</span>
    }
<span class="cstat-no" title="statement not covered" >    _writeHead.apply(res, arguments)</span>
  }
&nbsp;
